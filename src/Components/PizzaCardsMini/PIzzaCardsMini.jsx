import pizza_mini from '../../img/pizza_mini.png';
    ...
    return(
        ...
        <div className="cards-pizza__block">
            <div className="cards-pizza__item">
                <img src={pizza_mini} alt="pizza mini" className="cards-pizza__img" />
                <div className="cards-pizza__type">
                    <div className="cards-pizza__name">Сырный цыпленок</div>
                    <span className="cards-pizza__options">тонкое тесто</span>
                    <span className='cards-pizza__options'>,</span>
                    <span className='cards-pizza__options'> 26 см.</span>
                </div>
            </div>
            

            <div className="cards-pizza__amount">
                <button className="cards-pizza__amount-btn"><div className='minus'>-</div></button>
                <span className="cards-pizza__amount-num">1</span>
                <button className="cards-pizza__amount-btn active"><div className='plus'>+</div></button>
            </div>

            <div className="cards-pizza__price">770 ₴</div>

            <div className="cards-pizza__dlt">
